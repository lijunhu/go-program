...
func TestEtcdMutex(t *testing.T) {
	var conf = clientv3.Config{
		Endpoints:   []string{"10.160.84.104:2379","10.160.84.105:22379","10.160.84.106:32379"},
...
func TestEtcdGet(t *testing.T){
	...
	client,_ := clientv3.New(conf)
	response,_ := client.Get(context.TODO(),"/janus/config/5cfb7443b1e3c1519246ce42/idc1/md5sum")

	for _,kvs := range response.Kvs {
		fmt.Println(string(kvs.Value))
	}
}
